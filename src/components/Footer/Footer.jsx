...
const Footer = () => {
  return (
    <footer>
      <div>
        <img
          src="\static\images\Logo-bebece-footer.svg"
          alt="Logo Bebecê"
          className="logo-bebece-footer"
        />
      </div>
      <div className="redes-sociais">
        ...
        <a
          href="https://www.facebook.com/share/1BJmNFKTjG/?mibextid=wwXIfr"
          target="_blank"
        >
      ...
      <div>
        <span className="titulo-link-footer">Sobre a empresa</span>
        <br />
      ...
      <div>
        <span className="titulo-link-footer">Políticas</span>
        <br />
        <a href="#" className="links-footer">
