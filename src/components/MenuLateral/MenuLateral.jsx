    ...
    <>
      {isMobile && (
        <div className={`side-menu ${isMenuOpen ? "open" : ""}`}>
          ...
          <div>
            <img
              src="\static\images\banner-principal-1-mobile.png"
              alt=""
              className="img-menu-lateral"
            />
          </div>
          <div className="transparencia-menu-lateral">
            <span className="celebration-text-menu">Celebration - 20 anos</span>
            <a href="" className="link-conheca-menu">
              Conheça
            </a>
          </div>
            ...
            <ul>
              ...
              <li onClick={() => exibeSubmenu("sapatos")}>
                ...
                <img
                  src={
                    itemExpandido
                      ? "/static/images/seta-baixo-menu.svg"
                      : "/static/images/seta-direita-menu.svg"
                  }
                  alt="Seta direita menu"
                />
              </li>
              ...
              <li>
                <a href="#">Sandálias</a>
                <img
                  src="\static\images\seta-direita-menu.svg"
                  alt="Seta direita menu"
                />
              </li>
              <li>
              ...
              <li>
                <a href="#" className="outlet-text-menu">
                  Outlet
                </a>
              </li>
            </ul>
