        ...
        <Slider {...settings} className="slider-custom-blog">
          <div className="container-link">
            <a href="#" className="link-blog">
              <img
                src="\static\images\img-blog-1.png"
                alt=""
                className="img-blog"
              />
              <h3 className="titulo-blog">É AMANHÃ</h3>
              <p className="texto-blog">
                SIMPLE and TRUE: lançamento da nova coleção Outono Inverno 2024
                da Bebecê ❤️
              </p>
          ...
          <div className="container-link">
            <a href="#" className="link-blog">
              <img
                src="\static\images\img-blog-2.png"
                alt=""
                className="img-blog"
              />
          ...
          <div className="container-link">
            <a href="#" className="link-blog">
              <img
                src="\static\images\img-blog-3.png"
                alt=""
                className="img-blog"
              />
              <h3 className="titulo-blog">Descubra o glamour em cada passo.</h3>
              <p className="texto-blog">
                Quer brilhar ainda mais neste inverno sem abrir mão do conforto?
                Esta mule é perfeita para você. ✨
              </p>
              <p className="saiba-mais-blog">Saiba mais!</p>
            </a>
          </div>
